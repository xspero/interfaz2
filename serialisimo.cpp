...
void Serialisimo::enviardimmer(int numero)
{
        ...
        //serial->write(a);
            ...
            /*
             * //metodo monce
            int value=bufferTX[0]; //es 126 ó 0x7E... //empiezo con un int
            QString hexvalue=0; //incializado
            ...
            //QByteArray jeje[1]={hexvalue.toStdString().c_str()};
